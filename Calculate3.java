...
public class Calculate3
{
	//Value set*********
	double Oil=1600;
	double Detergent=1145;
	double Tea=85;
	double Rice=300;
	double TaxP=7.50;
	public Calculate3(String aaas,String as111,String as222,String as333,String jjj1)
	{
		JFrame fc2=new JFrame("  ");
		fc2.setResizable(false);
		
		ImageIcon icon3=new ImageIcon(getClass().getResource("image.jpg"));
		fc2.setIconImage(icon3.getImage());
		
		Container co=new Container();
		co=fc2.getContentPane();
		...
		JLabel la1=new JLabel("Total Price of Groceries Items");
		la1.setBounds(185,5,400,20);
		p1.add(la1);
		...
		p3.add(tx9);
		tx9.setText(String.valueOf(Oil));
		...
		p3.add(tx10);
		tx10.setText(String.valueOf(Detergent));
		...
		p3.add(tx11);
		tx11.setText(String.valueOf(Tea));
		...
		p3.add(tx12);
		tx12.setText(String.valueOf(Rice));
		...
		ba5.setBounds(70,270,67,25);
				...
				ba5.setBackground(Color.MAGENTA);
		...
		ba5.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				try{
					FileWriter w2=new FileWriter("rakib.txt",true);
					w2.write(s+" "+s1+"\n"+s2+" "+s3+"\n"+s4+" "+s5+"\n"+s6+" "+s7+"\n"+s8+" "+s9+"\n"+s10+" "+s11+"\n"+s12+" "+s13+"\n"+s14+" "+s15+"\n"+s16+" "+s17+"\n");
		...
		ba3.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{*/
					String noo7=tx1.getText().toString();
					fc2.dispose();
					Page3 p3=new Page3(noo7);
				/*}
				else
				{
		...
		ba6.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				String noo8=tx1.getText().toString();
				fc2.dispose();
				String g21=tx1.getText();
				String g22=tx2.getText();
				String g23=tx3.getText().toString();
				String g24=tx4.getText().toString();
				String g25=tx5.getText().toString();
				String g26=tx6.getText().toString();
				String g27=tx7.getText().toString();
				String g28=tx8.getText().toString();
				String g29=tx18.getText().toString();
				String g30=tx19.getText().toString();
				Payment3 mn2 =new Payment3(g21,g22,g23,g24,g25,g26,g27,g28,g29,g30,noo8);
			}
		});
		p4.add(ba6);
				...
				fc2.setSize(800,500);
				fc2.setLocationRelativeTo(null);
				fc2.setLayout(null);
				fc2.setVisible(true);
