...
public class SignTable 
{
	...
	JCheckBox check2 = new JCheckBox("Female");*/
		...
		label2.setBounds(30,87, 300,50);
		label3.setBounds(70,145, 300,50);
		label4.setBounds(70,195, 300,50);
		label5.setBounds(70,245, 300,50);
		//label6.setBounds(70,272, 300,50);
		label7.setBounds(70,297, 90,50);
		//label8.setBounds(543,170, 90,50);
		label9.setBounds(540,145, 120,50);
		label10.setBounds(540,195, 120,50);
		//label11.setBounds(70,410, 120,50);
		
		//fields positions
		text1.setBounds(180,160, 230,22);
		text2.setBounds(180,209, 230,22);
		text3.setBounds(180,262, 230,22);
		Tx.setBounds(180,312, 230,22);
		//text4.setBounds(632,185, 230,22);
		text5.setBounds(668,160, 170,22);
		text6.setBounds(668,209, 170,22);
		...
		F.add(back);
		ImageIcon iback=new ImageIcon(getClass().getResource("back.jpg"));
		back.setIcon(iback);
