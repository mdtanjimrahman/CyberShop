...
public class Calculate2
{
	...
	double Bag=11000;
	double TaxP=7.50;
	public Calculate2(String aas,String as11,String as22,String as33,String jjj)
	{
		JFrame fc1=new JFrame("  ");
		fc1.setResizable(false);
		
		ImageIcon icon3=new ImageIcon(getClass().getResource("image.jpg"));
		fc1.setIconImage(icon3.getImage());
		
		Container co=new Container();
		co=fc1.getContentPane();
		...
		JLabel la1=new JLabel("Total Price of Lifestyle Product");
		la1.setBounds(190,5,400,20);
		p1.add(la1);
		...
		p3.add(tx9);
		tx9.setText(String.valueOf(Cream));
		...
		p3.add(tx10);
		tx10.setText(String.valueOf(Perfume));
		...
		p3.add(tx11);
		tx11.setText(String.valueOf(Mask));
		...
		p3.add(tx12);
		tx12.setText(String.valueOf(Bag));
		...
		double sub1=q1*Cream;
		double sub2=q2*Perfume;
		double sub3=q3*Mask;
		double sub4=q4*Bag;
		...
		ba5.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				try{
					FileWriter w1=new FileWriter("rakib.txt",true);
					w1.write(s+" "+s1+"\n"+s2+" "+s3+"\n"+s4+" "+s5+"\n"+s6+" "+s7+"\n"+s8+" "+s9+"\n"+s10+" "+s11+"\n"+s12+" "+s13+"\n"+s14+" "+s15+"\n"+s16+" "+s17+"\n");
		...
		ImageIcon ge1=new ImageIcon(getClass().getResource("but.jpg"));
		ba3.setIcon(ge1);
		...
		ba3.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{*/
					String noo5=tx1.getText().toString();
					fc1.dispose();
					Page1 p1=new Page1(noo5);
				/*}
				else
				{
		...
		ba6.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				String noo6=tx1.getText().toString();
				fc1.dispose();
				String g11=tx1.getText();
				String g12=tx2.getText();
				String g13=tx3.getText().toString();
				String g14=tx4.getText().toString();
				String g15=tx5.getText().toString();
				String g16=tx6.getText().toString();
				String g17=tx7.getText().toString();
				String g18=tx8.getText().toString();
				String g19=tx18.getText().toString();
				String g20=tx19.getText().toString();
				Payment2 mn1=new Payment2(g11,g12,g13,g14,g15,g16,g17,g18,g19,g20,noo6);
			}
		});
		p4.add(ba6);
				...
				fc1.setLayout(null);
				fc1.setVisible(true);
				fc1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				fc1.setResizable(false);
	}
}
